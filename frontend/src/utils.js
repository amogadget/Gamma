...
// Explicit extension: Vite would infer it, but utils.js is also loaded
// directly by `node --test` (utils.test.js), and Node's ESM resolver does not.
import { makeBlockId } from "./logseqPdfModel.js";
