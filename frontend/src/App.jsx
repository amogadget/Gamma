...
export default function App() {
  ...
  // Folder-agent permissions: one flag per tool. Missing keys mean allowed,
  // so tools introduced later default on for existing users.
  const [agentPerms, setAgentPerms] = usePersistedState(
    "gamma-ai-agent-perms",
    AGENT_PERMS_DEFAULT,
    AGENT_PERMS_CODEC,
  );
