...
export const FilePlusIcon = (p) => (
  <Icon {...p}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><path d="M14 2v6h6" /><path d="M12 18v-6" /><path d="M9 15h6" /></Icon>
);
...
export const QuoteIcon = (p) => (
  <Icon {...p}><path d="M3 6h2m4 0h12M3 12h2m4 0h12M3 18h2m4 0h8" /><path d="M6 4v16" /></Icon>
);
...
// Handwriting strip: the hand (no tool armed — scroll and select text).
export const HandIcon = (p) => (
  <Icon {...p}><path d="M18 11V6a2 2 0 0 0-4 0v5" /><path d="M14 10V4a2 2 0 0 0-4 0v2" /><path d="M10 10.5V6a2 2 0 0 0-4 0v8" /><path d="M18 8a2 2 0 1 1 4 0v6a8 8 0 0 1-8 8h-2c-2.8 0-4.5-.86-5.99-2.34l-3.6-3.6a2 2 0 0 1 2.83-2.82L7 15" /></Icon>
);
...
// Big label glyph for grid tiles — the flat mirror of FolderGlyph. `dashed`
// is the "No label" pseudo-label: an empty outline, not a tag.
export function LabelGlyph({ dashed } = {}) {
  return (
    <svg className="tileGlyph labelGlyph" viewBox="0 0 24 24"
      fill={dashed ? "none" : "currentColor"} stroke={dashed ? "currentColor" : "none"}
      strokeWidth="1.5" strokeLinejoin="round" strokeDasharray={dashed ? "2.5 2" : undefined}>
      <path d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z" />
      {dashed ? null : <circle cx="7.5" cy="7.5" r="1.6" fill="var(--bg-card)" />}
    </svg>
  );
}
