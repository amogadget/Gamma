...
export const ANCHORS = {
  ...
  "account.firstRun": { view: "any", open: ["header.account", "account.tour"], description: "Your first paper tour" },
  "account.aiChat": { view: "any", open: ["header.account", "account.tour"], description: "AI chat tour" },
