...
import zotero from "./brands/zotero.svg";
import gamma from "./brands/gamma.svg";

const APP_ICONS = { obsidian, logseq, zotero, gamma };
...
export function FormatIllustration({ format }) {
  ...
  let icon;
  if (appIcon) icon = <span className="formatAppIcon" style={{ "--app-icon": `url("${appIcon}")` }} />;
